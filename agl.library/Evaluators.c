...
void glEvalCoord1d(GLdouble u __asm("fp0")) { LOG; PUSHREGS; _glEvalCoord1d(u); POPREGS; }
void glEvalCoord1f(GLfloat u __asm("fp0")) { LOG; PUSHREGS; _glEvalCoord1f(u); POPREGS; }
...
void glEvalCoord2d(GLdouble u __asm("fp0"), GLdouble v __asm("fp1")) { LOG; PUSHREGS; _glEvalCoord2d(u, v); POPREGS; }
void glEvalCoord2f(GLfloat u __asm("fp0"), GLfloat v __asm("fp1")) { LOG; PUSHREGS; _glEvalCoord2f(u, v); POPREGS; }
...
void glMapGrid1d(GLint un __asm("d0"), GLdouble u1 __asm("fp0"), GLdouble u2 __asm("fp1")) { LOG; PUSHREGS; _glMapGrid1d(un, u1, u2); POPREGS; }
void glMapGrid1f(GLint un __asm("d0"), GLfloat u1 __asm("fp0"), GLfloat u2 __asm("fp1")) { LOG; PUSHREGS; _glMapGrid1f(un, u1, u2); POPREGS; }
void glMapGrid2d(GLint un __asm("d0"), GLdouble u1 __asm("fp0"), GLdouble u2 __asm("fp1"), GLint vn __asm("d1"), GLdouble v1 __asm("fp2"), GLdouble v2 __asm("fp3")) { LOG; PUSHREGS; _glMapGrid2d(un, u1, u2, vn, v1, v2); POPREGS; }
void glMapGrid2f(GLint un __asm("d0"), GLfloat u1 __asm("fp0"), GLfloat u2 __asm("fp1"), GLint vn __asm("d1"), GLfloat v1 __asm("fp2"), GLfloat v2 __asm("fp3")) { LOG; PUSHREGS; _glMapGrid2f(un, u1, u2, vn, v1, v2); POPREGS; }
void glEvalPoint1(GLint i __asm("d0")) { LOG; PUSHREGS; _glEvalPoint1(i); POPREGS; }
void glEvalPoint2(GLint i __asm("d0"), GLint j __asm("d1")) { LOG; PUSHREGS; _glEvalPoint2(i, j); POPREGS; }
void glEvalMesh1(GLenum mode __asm("d0"), GLint i1 __asm("d1"), GLint i2 __asm("d2")) { LOG; PUSHREGS; _glEvalMesh1(mode, i1, i2); POPREGS; }
void glEvalMesh2(GLenum mode __asm("d0"), GLint i1 __asm("d1"), GLint i2 __asm("d2"), GLint j1 __asm("d3"), GLint j2 __asm("d4")) { LOG; PUSHREGS; _glEvalMesh2(mode, i1, i2, j1, j2); POPREGS; }